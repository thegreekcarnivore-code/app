...
## 9α. Ανώνυμη αναφορά επιτυχίας
Η πρόοδός σου μπορεί να χρησιμοποιηθεί ως ανώνυμη αναφορά επιτυχίας του προγράμματος — αριθμοί, αποτελέσματα, ποσοστά και γενικές παρατηρήσεις. **Δεν δημοσιεύονται ποτέ προσωπικά σου στοιχεία**: όνομα, πρόσωπο ή στοιχεία επικοινωνίας. **Καμία φωτογραφία σου δεν χρησιμοποιείται δημόσια** χωρίς να σου ζητηθεί πρώτα συγκεκριμένη, ξεχωριστή άδεια για κάθε χρήση.

## 10. Αποθήκευση, ασφάλεια και πρόσβαση
Η πλατφόρμα έχει σχεδιαστεί με υψηλά standards ασφάλειας. Χρησιμοποιείται ευρωπαϊκή υποδομή φιλοξενίας (Supabase EU, Stripe EU) ώστε τα δεδομένα σου να παραμένουν εντός Ευρωπαϊκής Ένωσης. Εφαρμόζονται οι βέλτιστες τεχνικές κρυπτογράφησης, ελέγχου πρόσβασης και ασφάλειας, σε πλήρη συμμόρφωση με τις απαιτήσεις του GDPR. Η πρόσβαση στα στοιχεία σου περιορίζεται αυστηρά στο ελάχιστο απαραίτητο για τη λειτουργία της υπηρεσίας.
...
Έχεις τα δικαιώματα που σου παρέχει ο GDPR σχετικά με τα προσωπικά σου δεδομένα:

- πρόσβαση στα δεδομένα σου,
- διόρθωση ή ενημέρωσή τους,
- διαγραφή όπου είναι εφικτό,
- φορητότητα των δεδομένων σου,
- απορίες για τον τρόπο χρήσης τους.
...
All coaching support is delivered through the **Σύμβουλος** in the app. It draws on your intake form, measurements, prior conversations, and the program's scientific/practical material to give you targeted guidance. **It is not a clinical advisor and does not provide medical instructions.**
...
- logged your food daily in the app,
...
## 9a. Anonymous success references
Your progress may be used as an anonymous reference of program success — numbers, results, percentages, and general observations. **No personal details are ever published**: name, face, or contact information. **None of your photos are used publicly** without you being asked first for specific, separate consent for each use.

## 10. Storage, security, and access
The platform is designed with high security standards. European-hosted infrastructure (Supabase EU, Stripe EU) keeps your data within the European Union. Industry-best encryption, access control, and security practices are applied in full GDPR compliance. Access to your information is strictly limited to the minimum necessary to deliver the service.
...
## 12. Your data rights
You have the rights granted to you by GDPR regarding your personal data:
