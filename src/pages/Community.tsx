...
const Community = () => {
  ...
  return (
    <div className="space-y-5 px-1 pt-14 pb-24">
      <section className="rounded-[2rem] border border-border/70 bg-[linear-gradient(135deg,hsl(var(--beige))_0%,hsl(var(--background))_100%)] p-5 shadow-sm">
        <div className="space-y-3">
          ...
          <p className="max-w-2xl font-sans text-sm leading-relaxed text-muted-foreground">
            {lang === "el"
              ? "Η κοινότητα λειτουργεί ως layer υποστήριξης γύρω από το coaching σου. Μπες όταν χρειάζεσαι momentum, ιδέες ή αίσθηση ότι προχωράς μαζί με άλλους."
