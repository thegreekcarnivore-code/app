...
import AnnualPlanBanner from "@/components/home/AnnualPlanBanner";
        ...
        <div className="rounded-[1.75rem] border border-gold/20 bg-background/85 p-4 h-fit">
          ...
          <p className="mt-2 font-sans text-sm leading-relaxed text-muted-foreground">
            {currentWeek && totalWeeks
              ? isGreek
                ? `Βρίσκεσαι στην εβδομάδα ${currentWeek} από ${totalWeeks}. Η συνέπεια αυτής της εβδομάδας θα καθορίσει πόσο χρήσιμη θα είναι η επόμενη ανάλυση.`
      ...
      <motion.section initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12 }} className="grid gap-3 lg:grid-cols-[1.05fr,0.95fr]">
        ...
        <div className="rounded-[1.75rem] border border-gold/20 bg-background/80 p-4">
          <div className="space-y-2">
            ...
            <h2 className="font-serif text-xl font-semibold text-foreground">
              {nextCheckInLabel
                ? (isGreek ? "Κράτα έτοιμη την εβδομαδιαία σου ανάλυση" : "Keep your next weekly review ready")
            ...
            <p className="font-sans text-sm leading-relaxed text-muted-foreground">
              {nextCheckInLabel
                ...
                : isGreek
                  ? "Άνοιξε τις μετρήσεις και κράτα σώμα, φαγητό και φωτογραφίες ενημερωμένα για να έχει νόημα η εβδομαδιαία ανάλυση."
